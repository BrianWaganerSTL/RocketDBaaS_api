# Generated by Django 2.1.1 on 2018-11-11 04:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('server_name', models.CharField(default='', max_length=30)),
                ('alert', models.CharField(default='', max_length=2048)),
                ('alert_cleared_sw', models.BooleanField(default=False)),
                ('start_dttm', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_dttm', models.DateTimeField(auto_now_add=True)),
                ('updated_dttm', models.DateTimeField(auto_now=True)),
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.ProtectedError, to='dbaas.Application')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_dttm', models.DateTimeField(default=datetime.datetime(9999, 12, 31, 23, 59, 59, 999999, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', models.CharField(choices=[('SBX', 'Sandbox'), ('DEV', 'Development'), ('QA', 'Quality Assurance'), ('UAT', 'User Acceptance Testing'), ('PRD', 'Production'), ('PPD', 'Post Production')], default='', max_length=20)),
                ...
                ('requested_mem_gb', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(2), django.core.validators.MaxValueValidator(64)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_dttm', models.DateTimeField(auto_now_add=True)),
                ('updated_dttm', models.DateTimeField(auto_now=True)),
                ('cluster', models.ForeignKey(on_delete=django.db.models.deletion.ProtectedError, to='dbaas.Cluster')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_cluster', models.ForeignKey(on_delete=django.db.models.deletion.ProtectedError, related_name='restore_to_cluster', to='dbaas.Cluster')),
            ],
            options={
                'db_table': 'restore',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_dttm', models.DateTimeField(auto_now_add=True)),
                ('updated_dttm', models.DateTimeField(auto_now=True)),
                ('cluster', models.ForeignKey(on_delete=django.db.models.deletion.ProtectedError, related_name='clusters', to='dbaas.Cluster')),
            ],
            options={
                'db_table': 'server',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_status', models.CharField(choices=[('Queued', 'Queued'), ('PendingRestart', 'PendingRestart'), ('Processing', 'Processing'), ('Failed', 'Failed'), ('Successful', 'Successful')], default='Queued', max_length=15)),
                ('start_dttm', models.DateTimeField(default=datetime.datetime(9999, 12, 31, 23, 59, 59, 999999, tzinfo=utc))),
                ('stop_dttm', models.DateTimeField(default=datetime.datetime(9999, 12, 31, 23, 59, 59, 999999, tzinfo=utc))),
        ...
        migrations.AddField(
            ...
            name='contact',
            field=models.ForeignKey(on_delete=django.db.models.deletion.ProtectedError, to='dbaas.Contact'),
        ),
        migrations.AddField(
            model_name='alerts',
            name='cluster',
