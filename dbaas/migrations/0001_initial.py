...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DataCenter',
            fields=[
                ('data_center', models.CharField(default='', max_length=15, primary_key=True, serialize=False)),
                ('order', models.IntegerField(unique=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(99)])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_dttm', models.DateTimeField(auto_now_add=True)),
                ('updated_dttm', models.DateTimeField(auto_now=True)),
                ('data_center', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='dbaas.DataCenter')),
